...
-- @author Junki Kim
-- @version 1.0.0
-- @description A tool for managing tracks, including batch adjusting volume/pan, selecting tracks by folder level, and batch renaming.
--========================================================
...
function main()
    ...
    if visible then
        ...
        changed, base_name = reaper.ImGui_InputTextMultiline(ctx, " ", text, 292, 22)
        reaper.ImGui_SameLine(ctx)
        ...
        if reaper.ImGui_Button(ctx, 'Create Regions', 208, 22) then
