...
-- @author Junki Kim
-- @version 0.9.5
-- @description A tool to batch/randomly adjust properties like volume, pitch, play rate, and position of selected media items, and perform group time stretching.
--========================================================
...
function main()
    ...
    reaper.ImGui_SetNextWindowSize(ctx, 650, 540, reaper.ImGui_Cond_Once())
